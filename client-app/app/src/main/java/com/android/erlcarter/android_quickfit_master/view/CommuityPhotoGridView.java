...
public class CommuityPhotoGridView extends GridView {

    private OnTouchInvalidPositionListener onTouchInvalidPositionListener;

    public CommuityPhotoGridView(Context context) {
        super(context);
    }

    public CommuityPhotoGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
